...
class DataTrainingArguments:
    ...
    valid_oos_file: Optional[str] = field(
        default=None, metadata={"help": "A csv or a json file containing the validation oos data."}
    )
...
def main():
    ...
    train_oos_dataset = datasets['train_oos']
    ...
    if training_args.do_predict:
        evaler = Evaluation(
            ...
            args=training_args,
            train_dataset=train_dataset,
            train_oos_dataset=train_oos_dataset,
